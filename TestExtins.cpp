...
void testCreeaza() {
	std::cout << "Creaza inceput" << std::endl;
	Colectie c;
	assert(c.dim() == 0);
	assert(c.vida() == true);
	...
	std::cout << "Creaza final" << std::endl;
}

void testAdauga() {
	std::cout << "Adauga inceput" << std::endl;
	...
	assert(c.dim() == 20240);
	std::cout << "Adauga final" << std::endl;
}

void testSterge() {
	std::cout << "Sterge inceput" << std::endl;
	Colectie c;
	...
	assert(c.dim() == 342);
	std::cout << "Sterge final" << std::endl;
}
...
void testIterator() { // nu stim reprezentarea Colectiei, putem testa doar anumite lucruri generale, nu stim in ce ordine vor fi afisate elementele.
	std::cout << "Iterator inceput" << std::endl;
	Colectie c;
	...
	std::cout << "Iterator final" << std::endl;
}

void testQuantity() {//scopul e sa adaugam multe date 
	std::cout << "Quantity inceput" << std::endl;
	Colectie c;
	for (int i = 10; i >= 1; i--) {
	...
	assert(c.dim() == 0);
	std::cout << "Quantity final" << std::endl;
}
